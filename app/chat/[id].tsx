...
import { ActivityIndicator, Animated, Image, KeyboardAvoidingView, Modal, Platform, Pressable, ScrollView, Text, View, FlatList } from 'react-native';
...
function TypingIndicator() {
  ...
  return <Animated.View style={{ opacity: pulse, flexDirection: 'row', gap: 4, paddingVertical: 4 }}><View style={{ width: 6, height: 6, borderRadius: 3, backgroundColor: colors.accent }} /><View style={{ width: 6, height: 6, borderRadius: 3, backgroundColor: colors.accent }} /><View style={{ width: 6, height: 6, borderRadius: 3, backgroundColor: colors.accent }} /></Animated.View>;
}
